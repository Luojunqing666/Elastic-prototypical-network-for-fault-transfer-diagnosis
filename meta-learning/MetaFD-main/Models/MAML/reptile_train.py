...
class Reptile_learner(object):
    ...
    @staticmethod
    def build_tasks(mode='train', ways=4, shots=5, num_tasks=100, filter_labels=None):
    ...
    def train(self, save_path, shots):
        ...
        for ep in range(Epochs):
            ...
            if (ep + 1) >= 100 and (ep + 1) % 2 == 0:  #原本是800
...
if __name__ == "__main__":
    ...
    path = r"D:\元学习\model_save\meta_learning\Reptile\5shot\Reptile_T2"
    Net.train(save_path=path, shots=5)
    path = r"D:\元学习\model_save\meta_learning\Reptile\5shot\Reptile_T2_ep100"
    Net.test(path, shots=5, inner_test_steps=30)
    # os.remove(r"D:\元学习\model_save\meta_learning\Reptile\5shot\Reptile_T2_ep100")
    #
    # if input('Train? y/n\n').lower() == 'y':
    ...
    #     # Net.test(path, shots=5, inner_test_steps=30)
    #
    #     path = r"D:\元学习\model_save\meta_learning\Reptile\5shot\Reptile_T2_ep800"
    #     Net.test(path, shots=5, inner_test_steps=30)
