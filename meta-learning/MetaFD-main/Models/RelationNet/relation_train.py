...
class RelationNet_learner(object):
    ...
    def train(self, save_path, shots):
        ...
        for ep in range(Epochs):
            ...
            if (ep+1) >=100 and (ep+1)%2==0:  # generally (ep+1) >=200  ##########
    ...
    def test(self, load_path, shots):
        ...
        test_tasks = self.build_tasks('test', test_ways, shots, 200, None)   #原本为1000
        loss_fun = torch.nn.CrossEntropyLoss()
...
if __name__ == "__main__":
    ...
    Net = RelationNet_learner(ways=5)  # T2
    path = r"D:\元学习\model_save\meta_learning\RelationNet\5shot\RelationNet_T1"
    Net.train(save_path=path, shots=5)
    load_path = r"D:\元学习\model_save\meta_learning\RelationNet\5shot\RelationNet_T1_ep100"
    Net.test(load_path, shots=5)
   # os.remove(r"D:\元学习\model_save\meta_learning\RelationNet\5shot\RelationNet_T1_ep100")
    ...
    # if input('Test? y/n\n').lower() == 'y':
    #
    #     load_path = r"D:\元学习\model_save\meta_learning\RelationNet\5shot\RelationNet_T1_ep200"
    #     Net.test(load_path, shots=5)
